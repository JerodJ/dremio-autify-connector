...
@SourceType(value = "AutifyARP", label = "Autify",uiConfig = "autify-layout.json")
public class AutifyConf extends AbstractArpConf<AutifyConf> {
  private static final String ARP_FILENAME = "arp/implementation/autify-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.autify.AutifyDriver";
